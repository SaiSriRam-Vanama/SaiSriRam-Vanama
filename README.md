...
<!-- Quick badges -->
<img src="https://img.shields.io/badge/AI%20Engineer-0f2027?style=for-the-badge&logo=OpenAI&logoColor=00C6FF" />
<img src="https://img.shields.io/badge/Full--Stack%20Developer-0f2027?style=for-the-badge&logo=react&logoColor=00C6FF" />
<img src="https://img.shields.io/badge/B.Tech%20Student-0f2027?style=for-the-badge&logo=googlescholar&logoColor=00C6FF" />
...
I'm a Final Year **B.Tech Computer Engineering (AI)** student at **Marwadi University**, and my goal is to build technology that's both innovative and impactful, while continuously growing as an engineer — one project, one patent, one line of code at a time. 🚀

```yaml
🎓 Status:      Final Year Student, Marwadi University
🎯 CGPA:        8.09 / 10
...
🤖 Interests:   Artificial Intelligence · Machine Learning · Computer Vision
                Generative AI · Full-Stack · Backend · Frontend Development
```
...
**Languages**
<br/>
<img src="https://skillicons.dev/icons?i=python,java,c,mysql,html,css,js,ts" />
...
<img src="https://img.shields.io/badge/JavaFX-FF6F00?style=for-the-badge&logo=oracle&logoColor=white"/>
...
**Tools & Platforms**
<br/>
<img src="https://skillicons.dev/icons?i=git,github,vscode,docker,postman,gcp,vercel" />
<img src="https://img.shields.io/badge/Render-46E3B7?style=for-the-badge&logo=render&logoColor=white"/>
<img src="https://img.shields.io/badge/Google%20Colab-F9AB00?style=for-the-badge&logo=googlecolab&logoColor=white"/>

</div>

> **Note on JavaFX:** shown as a dedicated badge above (rather than under the plain Java icon) since it represents a distinct desktop-UI skill separate from core Java.
...
### 🅿️ Park IQ — *Smart Parking, Solved with Computer Vision*

Real-time parking availability and intelligent slot management using computer vision and IoT sensors to detect, predict, and guide drivers to available spots — cutting down search time and reducing congestion in crowded lots.

**Highlights**
- 🎥 Live camera-feed slot detection powered by OpenCV
- 📡 IoT sensor integration via MQTT for real-time occupancy updates
- 🧭 Predictive guidance to route drivers to the nearest open spot
- ⚡ Full-stack deployment with a React dashboard and Flask API
...
### 📈 Pulse Lens AI — *Startup Health, Before the Metrics Turn Red*

An early-warning system for startup failure risk, built on public web signals — hiring velocity, funding news, and social sentiment — to flag trouble before conventional financial metrics catch up. Designed for investors, analysts, and founders who want a head start.

**Highlights**
- 🔍 Multi-signal ingestion pipeline (hiring, funding, sentiment)
- 🧠 ML models trained with Scikit-Learn & TensorFlow for risk scoring
- ⚙️ FastAPI backend serving predictions via a clean REST interface
- 📊 PostgreSQL-backed historical trend tracking
...
### 🧭 AI Career Autopilot — *Your Personalized Roadmap to the Right Job*

An intelligent career navigation platform that analyzes real-time job trends, personal skill gaps, and market demand to recommend tailored learning paths and opportunities — helping students and job-seekers move with data instead of guesswork.

**Highlights**
- 📊 Job-market trend analysis powered by Pandas
- 🎯 Personalized skill-gap detection and learning-path generation
- 🔥 Firebase-backed real-time user profiles and progress tracking
- 💻 Responsive Next.js + Tailwind interface
...
### 📜 Patent
**Thermal Management System for IT Infrastructure**
Application No. `202521090573 A`
Filed: 22 Sep 2025 · Published: 03 Oct 2025
Innovation focused on improving thermal efficiency and reliability in IT infrastructure environments.

### 💼 Internship
**Full Stack Engineer Intern** · Code Alpha
- Built full-stack web applications with responsive interfaces
...
- HackTheMountain
- Intellify 3.0
- Frontend Battle — Vibe Coding Competition (IIT Bhubaneswar)
...
<!--
  Profile Summary Cards (productive time, most committed day, language
  distribution, repository summary):
...
<!--
  This renders automatically once the GitHub Action below has run at
  least once (usually within a minute of enabling it). Until then,
  this space will simply show a broken/empty image — it will NOT
